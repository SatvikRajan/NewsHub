...
caps = (string)=>{
  ...
  async update(){
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=68f129b82f104fc9b85037350c517f81&page=${this.state.page}&pageSize=${this.props.pageSize}`;
